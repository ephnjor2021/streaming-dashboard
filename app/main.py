...
def get_stock_data(start: datetime, end: datetime, Symbol: str):
    def format_date(dt: datetime) -> str:
        return dt.isoformat(timespec="microseconds") + "Z"

    query = f"Stock WHERE ts BETWEEN '{format_date(start)}' AND '{format_date(end)}'"
